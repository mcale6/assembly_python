...
from assembly_python.pathway import Pathway, best_pathway_update, Duplicates
...
def check_subgraph_matches(current_pathway: Pathway, best_pathways: List[Pathway],
    ...
    """Check for matching subgraphs and track all valid pathways."""
            ...
            if neighbor_found:
                ...
                if len(sub) == k:
                    ...
                    if graph_is_isomorphic(subgraph, possible_duplicate):
                        ...
                        # Add pathway to list - keep all valid pathways
                        best_pathway_update(best_pathways, new_pathway, "all")
